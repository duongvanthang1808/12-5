...
namespace WebThoiTrang.Common
{
    public class Methods
    {
        ...
        //shop cart
        private bool IsOrderExsist(product_odered product)
        {
            ...
            else
            {
                ...
                return (products.Any(p => p.product_Ordered == product.product_Ordered && p.Size == product.Size && p.Color == product.Color));
            }
        }
        public void addtoCart(product_odered producttoAdd)
        {
            if(producttoAdd!=null)
            {
                ...
                else
                {
                    ...
                    {
                        var oldproduct=products.Where(p=>p.product_Ordered==producttoAdd.product_Ordered).FirstOrDefault();
